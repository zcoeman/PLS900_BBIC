...
#Setting a dataframe up
set.seed(6886)
df <- data.frame(
replicate(
6,
sample(c(1:10, -99, -88, -77, -66, NA), 12, rep=TRUE)
))
df
...
2. What does this function return? Why? Which principle does it illustrate?
  ...
  The reason that it returns 3 is ...
  The principle which it illustrates is...
```{r}
