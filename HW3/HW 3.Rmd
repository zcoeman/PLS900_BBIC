...
Next, we create a matrix from the 8 vectors
...
And finally, we round the matrix to teo decimal places, and transpose it so it matched the matrix in the slide
